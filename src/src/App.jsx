                ...
                <Canvas shadows camera={{ position: [5, 5, 5], fov: 70 }}>
                    ...
                    <group>
                        ...
                        <Ball
                            ...
                            color="white"
                            restitution={0.5}
                            getAutoPosition={getAutoPosition}
                        />
                        <Ball
                            position={[10, 1, 11.5]}
                            radius={[0.5]}
                    ...
                    <OrbitControls />
                    <DebugRenderer disabled />{" "}
                    {/* remove flag to use, caution: it lags a ton.(will fix later) */}
                    <Stats />
                    <PhysicsUpdater vehicleRef={vehicleRef} />{" "}
                    {/* Don't touch */}
                </Canvas>
                <ChatOverlay />
            </PhysicsWorld>
